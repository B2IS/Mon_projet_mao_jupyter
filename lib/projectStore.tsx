...
const PROJETS_INIT: Projet[] = [
  ...
  mkMatrixProjet({ id: 'prj-046', domaine: 'distribution', code: 'BEST-LOT1', nom: 'NG-ECOWAS-DEM-315397-CW-RFB: BEST-Lot 1 (445 Localités) : Réseaux de distribution des postes des Régions de Ziguinchor, Sédhiou et du département de Medina Yoro Foulah de la région de Kolda-18 mois', chefProjet: 'Maodo SENE', programme: 'BEST', region: 'Ziguinchor', localisation: 'Ziguinchor', budget: 22783, budgetDecaisse: 14932, avancement: 41, unite: 'DPD', departement: 'DPD_DISTRIBUTION', statut: 'en_cours' }),
  mkMatrixProjet({ id: 'prj-047', domaine: 'distribution', code: 'BEST-LOT2', nom: 'NG-ECOWAS-DEM-315397-CW-RFB: BEST Lot 2 (312 Localités) : Lot 2 : réseaux de distribution des postes de la Région de Kolda excepté le département de Médina Yoro Foulah-18 mois', chefProjet: 'Maodo SENE', programme: 'BEST', region: 'Kolda', localisation: 'Kolda', budget: 25213, budgetDecaisse: 15630, avancement: 41, unite: 'DPD', departement: 'DPD_DISTRIBUTION', statut: 'en_cours' }),
  mkMatrixProjet({ id: 'prj-048', domaine: 'distribution', code: 'BEST-LOT3', nom: 'NG-ECOWAS-DEM-315397-CW-RFB : BEST-Lot 3 (284 Localités) : Réseaux de distribution des postes des Régions de Kedougou, Tambacounda et Kaolack-Tranche Ferme et Conditionnelle - 18 mois - Tranche Ferme: 16 mois - Tranche Conditionnelle: 10 mois à partir de M8 de la tranche ferme', chefProjet: 'Maodo SENE', programme: 'BEST', region: 'Tambacounda', localisation: 'Tambacounda', budget: 22176, budgetDecaisse: 13438, avancement: 33, unite: 'DPD', departement: 'DPD_DISTRIBUTION', statut: 'en_cours' }),
