...
import { Download, ChevronUp, ChevronDown as ChevronDownIcon, Plus, Trash2, TableProperties } from 'lucide-react';
...
export default function Budget() {
  ...
  const [budgetTab, setBudgetTab] = useState<'synthese' | 'plan_financier' | 'decomptes' | 'couts_collectes' | 'imputations'>('synthese');
  ...
  return (
    ...
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {/* ── TAB: TABLEUR IMPUTATIONS ─────────────────────────────────────────── */}
      {budgetTab === 'imputations' && <ImputationsTableur />}
...
/* ══════════════════════════════════════════════════════════════════════════════
   TABLEUR IMPUTATIONS — éditeur Excel-like persistant
   ══════════════════════════════════════════════════════════════════════════════ */
